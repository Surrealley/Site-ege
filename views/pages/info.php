...
<h4 style="text-align: center; color: green";>1. Информация </h4>
...
<h4 style="text-align: center; color: green";>2. Системы счисления </h4>
<ul class="list2a">
      <li><a href="views/pages/download/ege14.doc" style="color: black">Позиционные системы счисления</a></li>      
</ul>
<h4 style="text-align: center; color: green";>3. Логика </h4>
<ul class="list2a">
...
<h4 style="text-align: center; color: green";>Полезные сайты </h4>
<ul class="list2a">
      <li><a href="https://kpolyakov.spb.ru/" style="color: black">Сайт Полякова К.Ю. для подготовки к ЕГЭ по информатике</a></li>
     <li><a href="https://inf-ege.sdamgia.ru/" style="color: black">Образовательный портал для подготовки к экзаменам</a></li> 
...
<!--<iframe src="https://www.online-python.com/" width="650" height="300" scrolling="auto"> </iframe>-->
