...
setlocale( LC_ALL, 'ru_RU.CP1251', 'rus_RUS.CP1251', 'Russian_Russia.1251' ); //������������� ��������� WIN-1251
...
define( "HEADER", "ВИДЕОКОНФЕРЕНЦИЯ" ); //���������
	...
	<body>
		<div id="wrapper">
			...
			<div id="msgsDialog" class="block">
				...
				<label class="autoscroll"><input id="autoScroll" type="checkbox" checked="checked" /> ������������ �� ����</label>
			...
			<form action="" method="post" id="sendForm">
				<div id="sendDialog" class="block2">
					<input type="text" name="name" value="<?php echo( $name ); ?>" maxlength="<?php echo( MAXUSERNAMELEN ) ?>" placeholder="���" />
					<textarea name="text" placeholder="�����" style="margin-top: 0.5em;" maxlength="<?php echo( MAXUSERTEXTLEN ); ?>"></textarea>
					<input type="submit" value="���������" class="button" title="ctrl + enter" id="submit"/>
					<div class="ad"></div>
				</div>
			</form>
		</div>
